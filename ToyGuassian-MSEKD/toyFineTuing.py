...
for i in tqdm(range(100)):
  ...
  CE_list_combine.append(S4_results['CE'])
  CE_list_combine_reverse.append(S4_results['CE_reverse'])
...
np.save('Project1/results/L2_ptgt_pgt_list_combine_N'+str(NOISE)+'K_{}_DELTA_MU_{}.npy'.format(K_CLAS, DELTA_MU),np.array(L2_ptgt_pgt_list_combine))
np.save('Project1/results/CE_ptgt_pgt_list_combine_N'+str(NOISE)+'K_{}_DELTA_MU_{}.npy'.format(K_CLAS, DELTA_MU),np.array(CE_list_combine))
np.save('Project1/results/CE_reverse_ptgt_pgt_list_combine_N'+str(NOISE)+'K_{}_DELTA_MU_{}.npy'.format(K_CLAS, DELTA_MU),np.array(CE_list_combine_reverse))
np.save('Project1/results/test_acc_list_combine_N'+str(NOISE)+'K_{}_DELTA_MU_{}.npy'.format(K_CLAS, DELTA_MU),np.array(test_acc_list_combine))
print(scipy.stats.spearmanr(L2_ptgt_pgt_list_combine, test_acc_list_combine))
...
ax1.set_ylabel('Accuracy on test set', fontsize=12)
ax1.set_xlabel('MSE of p_tar and p*',fontsize=12)
...
ax2.set_ylabel('Accuracy on test set', fontsize=12)
ax2.set_xlabel('CE of p_tar and p*',fontsize=12)

# ax3 = fig.add_subplot(133)

# ax3.scatter(CE_list_combine_reverse, test_acc_list_combine, color='blue',alpha=0.6,label='Noisy p')
# # ax3.scatter(ce_oht_to_p_reverse,OHT_test_acc,color='green',label='OHT',marker='2',s=400,linewidth=4)
# ax3.scatter(ce_ls_to_p_reverse,LS_test_acc,color='orange',label='LS',marker='2',s=400,linewidth=4)
# ax3.scatter(0,GT_test_acc,color='red',label='GT',marker='2',s=400,linewidth=4)
# ax3.scatter(ce_kd_to_p_reverse,KD_test_acc,color='cyan',label='KD',marker='2',s=400,linewidth=4)
# ax3.scatter(ce_eskd_to_p_reverse,ESKD_test_acc,color='purple',label='ESKD',marker='2',s=400,linewidth=4)

# ax3.legend(fontsize=8)
# ax3.set_ylabel('Accuracy on test set', fontsize=12)
# ax3.set_xlabel('CE of p_tar and p*',fontsize=12)

plt.title('K = {}'.format(K_CLAS), fontsize = 16)

plt.show()
# plt.savefig('Project1/Figures/rbt_toy_acc_L2_N'+str(NOISE)+'K_{}.pdf'.format(K_CLAS))

np.save('Project1/results/L2_ptgt_pgt_list_combine_N'+str(NOISE)+'K_{}_DELTA_MU_{}.npy'.format(K_CLAS, DELTA_MU),np.array(L2_ptgt_pgt_list_combine))
np.save('Project1/results/test_ECE_list_combine_N'+str(NOISE)+'K_{}_DELTA_MU_{}.npy'.format(K_CLAS, DELTA_MU),np.array(test_ECE_list_combine))
